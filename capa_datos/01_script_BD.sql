...
DROP TABLE DETALLE_BOL CASCADE CONSTRAINTS;
DROP TABLE DETALLE_PED CASCADE CONSTRAINTS;
...
DROP TABLE FAM_PROV CASCADE CONSTRAINTS;
DROP TABLE FIADO CASCADE CONSTRAINTS;
DROP TABLE JERARQUIA CASCADE CONSTRAINTS;
DROP TABLE MEDIO_PAGO_BOL CASCADE CONSTRAINTS;
DROP TABLE MEDIO_PAGO CASCADE CONSTRAINTS;
DROP TABLE PEDIDO CASCADE CONSTRAINTS;
DROP TABLE PREG_SECRETA CASCADE CONSTRAINTS;
...
DROP TABLE VIGENCIA_PROD CASCADE CONSTRAINTS;
